...
var $author$project$PhotoFolders$initalModel = {
...
var $author$project$PhotoFolders$init = function (selectedFilename) {
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$PhotoFolders$initalModel,
...
var $author$project$PhotoGallery$sizeToClass = function (size) {
	switch (size.$) {
		case 'Small':
			return $author$project$PhotoGallery$sizeToString(size);
		case 'Medium':
			return 'med';
		default:
			return $author$project$PhotoGallery$sizeToString(size);
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$PhotoGallery$sizeToClass(model.chosenSize))
					]),
				A2(
					$elm$core$List$map,
